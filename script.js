...
let newArrProject = arrData.map((curElem, index)=>{
    return `<li class="slider slider1 p-20 ">
                                ...
                                <div class="my-img m-t-20">
                                    <img src="${curElem.imgPath}" alt="${curElem.alt + index}" class="border-round">
                                </div>
                                ...
                                <p class="text-16 fw-thin text-blue m-t-20">Github Link <i class="fa-solid fa-download"></i></p>
                                <p class="m-t-10"><a href="${curElem.link}" class="text-16 text-white" target="_blank">Open the link ...</a></p>
                            </li>`
});
